<%-- 
    Document   : AboutUs
    Created on : May 1, 2023, 9:39:08 AM
    Author     : brian
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            header {
                background-color: #0099cc; /* Set header color to blue */
    ...
    <body>
        <header>
           <img src="Zest_logo3.png" alt="" style=" padding-right: 1300px ;height:120px"/> 
        </header> 
<center><h1>   About Us </h1>  </center> </span>

<br>
<br>
<br>
<center><img src="coding.jpg" alt="" width='600px'/></center>
